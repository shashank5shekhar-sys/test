  ...
  static ThemeData get dark {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle:
            GoogleFonts.spaceGrotesk(color: textSecondary, fontSize: 14),
